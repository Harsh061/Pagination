...
private let unavailable: HTTPStatusCode! = nil
...
public extension HTTPStatusCode {
    ...
    static let springFrameworkMethodFailure = unavailable
    ...
    static let requestHeaderTooLarge = unavailable
    
    /// Network Timeout Error: 599
    ///
    /// Removed from Wikipedia page.
    @available(*, unavailable, message: "No longer available")
    static let networkTimeoutError = unavailable
}
